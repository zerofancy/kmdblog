...
class ConfigUtil {
    companion object {
        ...
        fun checkInit() {
            ...
            println(XMLUtil.readXMLDocument(getConfigPathAndFilename()).rootElement.textTrim)
            println(XMLUtil.readXMLDocument(getConfigPathAndFilename() + ".xml").rootElement.textTrim)
        }
    }
}